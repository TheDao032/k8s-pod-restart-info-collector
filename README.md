...
| `muteCronjobSeconds`                | The time to mute duplicate pod of cronjob alerts | default: `"600"`
...
| `watchedCronjobNamePrefixes`        | A set of cronjob name prefixes to be watched. This should be provided as a comma-separated list or a regular expression. | default: `""`
